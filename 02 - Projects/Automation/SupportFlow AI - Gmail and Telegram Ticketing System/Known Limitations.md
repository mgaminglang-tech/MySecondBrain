...
| LIM-007 | Airtable base/table/field IDs are verified; other service IDs and every credential remain Not Yet Assigned | External integration remains blocked | Keep Phase 1 credential-free and resolve each service gate separately | Mervin | partially resolved |
