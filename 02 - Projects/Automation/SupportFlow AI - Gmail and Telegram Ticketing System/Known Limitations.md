...
| LIM-007 | Airtable base/table/field IDs are verified and the Gemini credential stage is complete; other service IDs and credentials remain Not Yet Assigned | External integration remains incomplete | Resolve each remaining service gate separately; ClickUp is next | Mervin | partially resolved |
